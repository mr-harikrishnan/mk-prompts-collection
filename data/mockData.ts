...
export const INITIAL_PROMPTS: Prompt[] = [
  {
    ...
    image: "/images/tempcreatedimage.png",
    variables: [
  ...
  {
    id: "prompt-5",
    title: "Minimalist Aesthetic Portrait",
    category: "Aesthetic Art",
    shortDesc: "A premium minimalist illustration showcasing elegant portrait design lines.",
    longDesc: "This prompt generates a high-end minimalist portrait artwork. It utilizes clean vector line-art, balanced color accents, and a warm sand background to deliver an aesthetic visual ideal for wallpapers or poster designs.",
    template: "A premium, minimalist digital portrait artwork of {character_name} set against a soft, textured {background_color} background. Style is clean line-art with warm {accent_color} accents, system dashboard aesthetics, highly detailed.",
    image: "/images/tempcreatedimage.png",
    variables: [
      { name: "character_name", label: "Character Name", defaultValue: "Clara" },
      { name: "background_color", label: "Background Color", defaultValue: "warm sand" },
      { name: "accent_color", label: "Accent Color", defaultValue: "terracotta" }
    ],
    tags: ["Minimalist", "Portrait", "Aesthetic", "Line-Art", "Warm"],
    copyCount: 1250,
    stars: 4.9,
    totalReviews: 15
  }
